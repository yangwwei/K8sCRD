...
import (
	...
	examplev1alpha1 "github.com/yangwwei/K8sCRD/pkg/apis/example/v1alpha1"
	versioned "github.com/yangwwei/K8sCRD/pkg/client/clientset/versioned"
	internalinterfaces "github.com/yangwwei/K8sCRD/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/yangwwei/K8sCRD/pkg/client/listers/example/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ExampleV1alpha1().Applications(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ExampleV1alpha1().Applications(namespace).Watch(options)
			},
		},
		&examplev1alpha1.Application{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *applicationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&examplev1alpha1.Application{}, f.defaultInformer)
}
